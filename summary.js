...
if(tourDestinations[1] == 'nepal'){
    console.log('Spread the Message of Islam')
}
else if(tourDestinations[1] == 'china'){
    console.log('here also I will invite people to Islam')
}
else if(tourDestinations.length == 4){
    console.log('tell them to read their book')
}
else{
    console.log('I will do Dhikr of Allah')
}
